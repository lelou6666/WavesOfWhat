...
Training sets are always formed so that the yearly frequencies are equalized:
for every year Y there is an equal number of profession A and profession B notabilities
