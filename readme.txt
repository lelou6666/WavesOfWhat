...
Balanced set is then further split into a training and validation sets, the latter is used to select features.
...
Our goal is to find a classifier able to distinguish between groups (using astronomical factors only)
